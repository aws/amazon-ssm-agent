...
// SSMMDS is a client for Amazon SSM MDS.
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion string) *SSMMDS {
	svc := &SSMMDS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
