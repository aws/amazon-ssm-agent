...
const (
	...
	// ErrCodeCommandNotFound for service response error code
	// "CommandNotFound".
	ErrCodeCommandNotFound = "CommandNotFound"

	// ErrCodeCommandNotInTerminalState for service response error code
	// "CommandNotInTerminalState".
	ErrCodeCommandNotInTerminalState = "CommandNotInTerminalState"

	// ErrCodeCommandNotInteractive for service response error code
	// "CommandNotInteractive".
	ErrCodeCommandNotInteractive = "CommandNotInteractive"
	...
	// ErrCodeDuplicateCommandId for service response error code
	// "DuplicateCommandId".
	ErrCodeDuplicateCommandId = "DuplicateCommandId"
	...
	// ErrCodeInvalidInventoryResourceIdException for service response error code
	// "InvalidInventoryResourceIdException".
	ErrCodeInvalidInventoryResourceIdException = "InvalidInventoryResourceIdException"

	// ErrCodeInvalidInventoryResourceTypeException for service response error code
	// "InvalidInventoryResourceTypeException".
	ErrCodeInvalidInventoryResourceTypeException = "InvalidInventoryResourceTypeException"
	...
	// ErrCodeRAMInternalIdMismatchException for service response error code
	...
	ErrCodeRAMInvalidSequenceNumberException = "RAMInvalidSequenceNumberException"

	// ErrCodeRAMResourceNotFoundException for service response error code
	// "RAMResourceNotFoundException".
	//
	// ROS cannot find a resource with the given resource ARN
	ErrCodeRAMResourceNotFoundException = "RAMResourceNotFoundException"

	// ErrCodeRAMResourceNotSharedException for service response error code
	...
	// ErrCodeServiceLinkedRoleLockServiceException for service response error code
