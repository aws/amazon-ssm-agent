...
// SageMakerMetrics provides the API operation methods for making requests to
// Amazon SageMaker Metrics Service. See this package's package overview docs
// for details on the service.
//
// SageMakerMetrics methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *SageMakerMetrics {
...
// newRequest creates a new request for a SageMakerMetrics operation and runs any
// custom request initialization.
func (c *SageMakerMetrics) newRequest(op *request.Operation, params, data interface{}) *request.Request {
