...
cp ${BGO_SPACE}/Tools/src/update/ubuntu/install.sh ${BGO_SPACE}/bin/debian_arm64/
cp ${BGO_SPACE}/Tools/src/update/ubuntu/uninstall.sh ${BGO_SPACE}/bin/debian_arm64/
...
chmod 755 ${BGO_SPACE}/bin/debian_arm64/install.sh ${BGO_SPACE}/bin/debian_arm64/uninstall.sh
...
tar -cvf ${BGO_SPACE}/bin/updates/amazon-ssm-agent/`cat ${BGO_SPACE}/VERSION`/amazon-ssm-agent-ubuntu-arm64.tar  -C ${BGO_SPACE}/bin/debian_arm64/ amazon-ssm-agent.deb install.sh uninstall.sh snap-install.sh snap-uninstall.sh
...
tar -zcvf ${BGO_SPACE}/bin/updates/amazon-ssm-agent-updater/`cat ${BGO_SPACE}/VERSION`/amazon-ssm-agent-updater-ubuntu-arm64.tar.gz  -C ${BGO_SPACE}/bin/linux_arm64/ updater
...
rm ${BGO_SPACE}/bin/debian_arm64/install.sh
rm ${BGO_SPACE}/bin/debian_arm64/uninstall.sh
