...
cp $PLUGIN_BINARIES/AWS.CloudWatch.exe $PACKAGING_FOLDER
cp $PLUGIN_BINARIES/AWS.CloudWatch.exe.config $PACKAGING_FOLDER
...
cp $PLUGIN_BINARIES/AWS.CloudWatch.log4net.config $PACKAGING_FOLDER