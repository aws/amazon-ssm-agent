...
cp ${BGO_SPACE}/seelog.xml ${BGO_SPACE}/bin/debian_amd64/debian/etc/amazon/ssm/
cp ${BGO_SPACE}/amazon-ssm-agent.json ${BGO_SPACE}/bin/debian_amd64/debian/etc/amazon/ssm/
cp ${BGO_SPACE}/packaging/amazon-ubuntu-ami/amazon-ssm-agent.conf ${BGO_SPACE}/bin/debian_amd64/debian/etc/init/
...
cp ${BGO_SPACE}/packaging/amazon-ubuntu-ami/conffiles ${BGO_SPACE}/bin/debian_amd64/debian/
cp ${BGO_SPACE}/packaging/amazon-ubuntu-ami/preinst ${BGO_SPACE}/bin/debian_amd64/debian/
cp ${BGO_SPACE}/packaging/amazon-ubuntu-ami/postinst ${BGO_SPACE}/bin/debian_amd64/debian/
cp ${BGO_SPACE}/packaging/amazon-ubuntu-ami/prerm ${BGO_SPACE}/bin/debian_amd64/debian/
cp ${BGO_SPACE}/packaging/amazon-ubuntu-ami/lintian-overrides ${BGO_SPACE}/bin/debian_amd64/debian/usr/share/lintian/overrides/amazon-ssm-agent
...
cat ${BGO_SPACE}/packaging/amazon-ubuntu-ami/control >> ${BGO_SPACE}/bin/debian_amd64/debian/control
...
cat ${BGO_SPACE}/packaging/amazon-ubuntu-ami/changelog >> ${BGO_SPACE}/bin/debian_amd64/debian/usr/share/doc/amazon-ssm-agent/changelog

cp ${BGO_SPACE}/packaging/amazon-ubuntu-ami/changelog.Debian ${BGO_SPACE}/bin/debian_amd64/debian/usr/share/doc/amazon-ssm-agent/
cp ${BGO_SPACE}/packaging/amazon-ubuntu-ami/debian-binary ${BGO_SPACE}/bin/debian_amd64/debian/
...
cd ${BGO_SPACE}/bin/debian_amd64/debian/; tar czf data.tar.gz usr etc opt --owner=0 --group=0 ; cd ~-
