...
cp $PLUGIN_BINARIES/AWS.DomainJoin.exe $PLUGIN_BINARIES
cp $PLUGIN_BINARIES/AWS.DomainJoin.exe.config $PLUGIN_BINARIES
cp $PLUGIN_BINARIES/log4net.config $PLUGIN_BINARIES
