...
cp $PLUGIN_BINARIES/AWS.DomainJoin.exe $CLOUDWATCH_FOLDER
cp $PLUGIN_BINARIES/AWS.DomainJoin.exe.config $CLOUDWATCH_FOLDER
cp $PLUGIN_BINARIES/log4net.config $CLOUDWATCH_FOLDER
