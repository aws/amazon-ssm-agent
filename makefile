...
# go test -v -gcflags "-N -l" -timeout 20m -tags=fastinteg github.com/aws/amazon-ssm-agent/agent/fileutil/...
	cd $(GOTEMPCOPYPATH) && go test -gcflags "-N -l" -timeout 20m -tags=fastinteg github.com/aws/amazon-ssm-agent/agent/...
