...
func (runnerMock *MockedPluginRunner) RunPlugins(context context.T, documentID string, plugins map[string]stateModel.PluginState, sendResponse runutil.SendResponse, cancelFlag task.CancelFlag) (pluginOutputs map[string]*contracts.PluginResult) {
