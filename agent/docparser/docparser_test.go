...
func TestParseDocument_ValidRuntimeConfig(t *testing.T) {
	...
	validdocumentruntimeconfig := loadFile(t, "../message/service/testdata/validcommand12.json")
...
func TestParseDocument_ValidMainSteps(t *testing.T) {
	...
	var testDocContent contracts.DocumentContent
	validdocumentmainsteps := loadFile(t, "../message/service/testdata/validcommand20.json")
