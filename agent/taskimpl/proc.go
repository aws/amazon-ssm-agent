...
func process(log log.T, job task.Job, cancelFlag *CancelFlag, cancelWait time.Duration, clock times.Clock) {
	...
	log.Debugf("Task has been canceled, waiting up to %v to finish", cancelWait)
