...
const (
	...
	// TODO: change to "AWS:InstanceDetailedInformation" once microservice accepts the new predefined type https://cr.amazon.com/r/7133520/
	GathererName = "Custom:InstanceDetailedInformation2"
